...
if(isset($_POST) && !empty($_POST)) {
    ...
    $sql = "SELECT u.username, b.amount_of_money, b.time_of_bid FROM user AS u INNER JOIN bid AS b ON u.id = b.user_id AND b.bids_id = (SELECT id FROM bids WHERE auction_id = ?);";
